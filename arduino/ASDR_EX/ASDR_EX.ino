...
void setup() {
  pinMode(11, OUTPUT);                     // set the analog output resolution to 12 bit (4096 levels) -> ARDUINO DUE ONLY
...
void loop() {
  ...
  analogWrite(11, adsr_class.getWave(t));         // update ADSR and write to DAC
